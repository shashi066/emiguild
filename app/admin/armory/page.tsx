...
import { getArmoryAdminConfig, serializeArmoryAdminConfig } from '@/lib/armory';
...
export default async function AdminArmoryPage() {
  try {
    ...
    return <AdminArmory initialConfig={JSON.parse(JSON.stringify(serializeArmoryAdminConfig(initialConfig)))} />;
  } catch (error) {
